...
class CustomersResource:
    ...
    async def list(self) -> BlindpayApiResponse[ListCustomersResponse]:
        return await self._client.get(f"/instances/{self._instance_id}/customers")
...
class CustomersResourceSync:
    ...
    def list(self) -> BlindpayApiResponse[ListCustomersResponse]:
        return self._client.get(f"/instances/{self._instance_id}/customers")
