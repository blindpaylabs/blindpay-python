...
- **POST /v1/upload/analyze** — Analyze Document
  Response (UploadAnalyzeOut):
    - approval_rate (string, enum: low | medium | high)
    - description (string)

## Removed Endpoints

- **POST /v1/instances/{instance_id}/api-keys**
- **GET /v1/instances/{instance_id}/api-keys**
- **GET /v1/instances/{instance_id}/api-keys/{id}**
...
These enum fields gained or lost values across all schemas:
  ...
  - ach: ADDED 3 values: blocked, veem, zenus
  ...
  - approval_rate: ADDED 3 values: high, low, medium
  - international_swift: ADDED 3 values: blocked, veem, zenus
  - kind: ADDED 2 values: payin, payout
  - manual_execution_status: ADDED 1 values: failed
  - rtp: ADDED 3 values: blocked, veem, zenus
  - webhook_event: ADDED 1 values: receiver.delete
  - wire: ADDED 3 values: blocked, veem, zenus

## New Schemas

- **CopyInstanceMembersIn** (1 fields)
- **CopyInstanceMembersOut** (3 fields)
- **LedgerOperation** (17 fields)
- **ManualReviewSkip** (3 fields)
- **MigrateInstanceOwnershipIn** (1 fields)
- **PaymentRoute** (4 fields)
- **ReceiverDeleteWebhookOut** (7 fields)
- **UploadAnalyzeIn** (3 fields)
- **UploadAnalyzeOut** (2 fields)
